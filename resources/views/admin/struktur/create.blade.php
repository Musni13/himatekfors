...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800" style="font-weight: bold;">Struktur Pengurus</h1>
    </div>
            ...
            <div class="col-xl-8 col-lg-7">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Struktur Pengurus</h6>
                    </div>
                    <div class="card-body border-bottom-primary">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jabatan" class="form-control" >
                                ...
                                <option value="PIMPINAN DIVISI">PIMPINAN DIVISI</option>
                        ...
                        <div class="form-group">
                            <label>Divisi</label>
                            <input type="text" name="divisi" class="form-control" placeholder="Masukkan Divisi"  oninput="this.value = this.value.toUpperCase()">
                        </div>
