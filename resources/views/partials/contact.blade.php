  ...
  <div class="row gy-4">
    ...
    <form action="{{ route('beranda.store') }}" method="POST" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="row gy-4">
        ...
        <div class="col-md-12">
          <textarea name="pesan" class="form-control" rows="6" placeholder="Message" required></textarea>
        </div>
        ...
        <div class="col-md-12 text-center">
          ...
          <button type="submit" class="btn btn-primary" onclick="this.closest('form').querySelector('.loading').classList.remove('d-none')"><i class="bi bi-send"></i> Send Message</button>
        </div>
