...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('assets/img/logo-hima.png') }}" rel="icon">
...
<main class="main">
  ...
  <script src="{{ asset('assets/template/vendor/glightbox/js/glightbox.min.js') }}"></script>
  <script src="{{ asset('assets/template/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
  <script src="{{ asset('assets/template/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
  <script src="{{ asset('assets/template/vendor/swiper/swiper-bundle.min.js') }}"></script>
